-- ============================================
-- COMPLETE FIX FOR ALL APIs
-- ============================================
-- Ye script sab tables ko fix karega aur sab APIs kaam karengi
-- Run this script in MySQL to fix all 500 errors
...
-- ============================================
-- STEP 3: Add company_id to Drivers Table
-- ============================================
SET @exists = (SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS 
               WHERE TABLE_SCHEMA = DATABASE() 
...
-- ============================================
-- STEP 4: Add company_id to Customers Table
-- ============================================
SET @exists = (SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS 
               WHERE TABLE_SCHEMA = DATABASE() 
...
-- ============================================
-- STEP 5: Add company_id to Trucks Table
-- ============================================
SET @exists = (SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS 
               WHERE TABLE_SCHEMA = DATABASE() 
...
-- ============================================
-- STEP 6: Add company_id to Tickets Table (MAIN ERROR)
-- ============================================
SET @exists = (SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS 
               WHERE TABLE_SCHEMA = DATABASE() 
...
-- SUCCESS MESSAGE
-- ============================================
SELECT '✅ SUCCESS! All tables fixed!' AS Status;
SELECT '✅ All APIs should work now!' AS Message;
SELECT '✅ Refresh your browser and try again!' AS NextStep;
